...
class ImagePickerComponent extends StatelessWidget {
  ...
  Widget prepearingUpload(ImagePickerValue value, BuildContext context,
    ...
    if (value.onProgressUpload == false &&
      ...
      controller.uploadFile(
        (value.uploadedId != null) && getUpdateUrl != null
            ? getUpdateUrl!(value)
            : uploadUrl ?? "",
        uploadField ?? "file",
        descriptionField,
  ...
  Widget networkImageMode(ImagePickerValue value) {
    ...
    return Container(
      ...
      child: Image.network(value.uploadedUrl ?? "", fit: BoxFit.scaleDown,
...
class ImagePickerController extends ValueNotifier<ImagePickerValue> {
  ...
  void uploadFile(
    ...
    ObjectBuilderWithParam<Map<String, String>, ImagePickerValue>?
        setQueryParams,
  }) async {
    ...
    try {
      ...
      await FileServiceUtil.fileUploadMultipart(
        ...
        queryParam: setQueryParams?.call(value) ?? {},
        onUploadProgress: (
          uploaded,
          fileSize,
        ) {
